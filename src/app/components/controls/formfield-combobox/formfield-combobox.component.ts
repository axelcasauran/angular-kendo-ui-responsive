...
@Component({
  selector: 'formfield-combobox',
  templateUrl: './formfield-combobox.component.html',
  styleUrls: ['./formfield-combobox.component.scss']
})
export class FormfieldComboboxComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    me.dataList = me.model.comboboxData;
    me.comboboxLabelDrillDownFn = me.model.comboboxLabelDrillDownFn;
